      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex gap-2">
            <input className={field} style={{ ...fieldStyle, flex: 1 }} placeholder="Image URL (optional — https:// or ipfs://)" value={image} onChange={(e) => setImage(e.target.value)} />
            <label className="rounded-xl px-3.5 py-2.5 text-sm font-semibold cursor-pointer transition-opacity hover:opacity-80 flex items-center gap-1.5 whitespace-nowrap" style={{ background: "var(--ae-veil)", color: "var(--clr-heading)", border: "1px solid var(--clr-border)" }}>
          ...
          {image && <img src={image} alt="preview" className="mt-2 rounded-xl object-cover" style={{ width: 64, height: 64, background: "var(--ae-veil)" }} onError={() => setImage("")} />}
        </div>
