          ...
          {!coin.graduated ? (
            ...
            <div className="rounded-2xl p-5 space-y-4" style={{ background: "var(--ae-haze)", border: "1px solid var(--clr-border)" }}>
              ...
              <div className="flex gap-2">
                <Link
                  href={`/exchange?inputCurrency=LCAI&outputCurrency=${coin.address}`}
                ...
                <Link
                  href={`/exchange?inputCurrency=${coin.address}&outputCurrency=LCAI`}
                  className="flex-1 rounded-xl py-2.5 text-sm font-semibold text-center transition-all"
              ...
              {/* DEX price chart */}
              {c.pair && <TradingChart pair={c.pair} symbol={coin.symbol} />}
